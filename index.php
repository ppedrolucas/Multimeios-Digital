...
<body>
    <div class="h-screen bg-zinc-300">
      <div class="container h-full p-4 mx-auto flex flex-col items-center justify-center">
        <div class="bg-zinc-200 rounded-lg p-4 w-80 flex flex-col">
            <h2 class="text-2xl font-bold text-center mb-4">Sign In</h2>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="w-full mb-4">
                        ...
                        <input id="name" name="nome" type="text" class="w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-green-500 sm:text-sm/6" placeholder="Digite seu nome" required/>
                    </div>
                    <div class="w-full mb-4">
                        <label for="matricula" class="text-sm/6 font-medium text-gray-900">Senha</label>
                        <input id="matricula" type="password" onkeypress="$(this).mask('0000000')" name="matricula" class="w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-green-500 sm:text-sm/6" placeholder="Digite sua senha" required/>
                    </div>
                    <div class="w-full mb-4">
